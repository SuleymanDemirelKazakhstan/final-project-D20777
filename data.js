...
MongoClient.connect(url,
  ...
  function (err, db) {
    ...
    let meat = [
      ...
      name: "GG Steak House",
      description: "Семейный ресторан в Горном Гиганте. Уютный интерьер GG STEAK HOUSE располагает к неторопливой приятной беседе, а вкусные блюда , приготовленные нашим шеф-поваром , настраивают на позитивную волну",
